...
const READ_LOCKING = READ_LATEST | 2 // READ_LATEST (1) and "LOCK IN SHARE MODE" (2)
/** @var int Read from the master/quorum and lock out other writers and locking readers */
const READ_EXCLUSIVE = READ_LOCKING | 4 // READ_LOCKING (3) and "FOR UPDATE" (4)
...
type IDBAccessObject interface {
